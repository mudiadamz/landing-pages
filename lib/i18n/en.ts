...
export const en: Record<keyof typeof id, string> = {
  ...
  "panel.idPhoto": "ID photo",
  "panel.selfiePhoto": "Selfie photo",
  "panel.legalName": "Full name as on your ID",
  "panel.legalNamePlaceholder": "Name exactly as written on the ID",
  "panel.shopName": "Shop name (publisher)",
  "panel.shopNamePlaceholder": "For example: Studio Senja",
  "panel.address": "Current home address",
  "panel.bankName": "Bank name",
  "panel.bankNamePlaceholder": "BCA, Mandiri, …",
  "panel.accountHolder": "Account holder",
  "panel.accountHolderPlaceholder": "As printed on the account",
  "panel.accountNumber": "Account number",
  "panel.applicationStatus": "Application status",
  "panel.payoutAccount": "Payout account",
  "panel.rejectReasonPlaceholder": "e.g. ID photo blurred / name does not match / selfie unclear.",
  ...
  /* delivery tab */
  "product.deliveryIntro": "The file a buyer receives after purchase.",
