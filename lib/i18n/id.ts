...
export const id = {
  ...
  "common.unsavedChanges": "Ada perubahan belum disimpan",
  "common.cancel": "Batal",
  "common.delete": "Hapus",
  "common.add": "Tambah",
  "common.edit": "Edit",
  ...
  "panel.customJsHistory": "Riwayat versi ({count})",
  "panel.customJsRestore": "Pulihkan",
  "panel.customJsRestoreHint": "Memulihkan hanya mengisi editor — tekan Simpan untuk menerapkannya.",
  ...
  /* delivery tab */
  "product.deliveryIntro": "Apa yang diterima pembeli setelah membeli.",

  /* ---- jenis produk (Fase 6: katalog untuk segala jenis bisnis) ---- */
  "product.typeLabel": "Jenis produk",
  "product.typeDigital": "Produk digital",
  "product.typePhysical": "Barang fisik",
  "product.typeService": "Jasa / layanan",
  "product.typeDigitalHint": "Pembeli langsung menerima filenya begitu pembayaran masuk.",
  "product.typePhysicalHint": "Pesanan masuk ke daftar pesanan di Penjualan untuk kamu kirim.",
  "product.typeServiceHint": "Pesanan masuk ke daftar pesanan di Penjualan untuk kamu jadwalkan.",
  "product.sku": "Kode barang (SKU)",
  "product.stock": "Stok",
  "product.stockHint": "Kosongkan kalau stok tidak dilacak. 0 berarti habis.",
  "product.unit": "Satuan",
  "product.unitPlaceholder": "pcs, porsi, jam",
  "product.serviceDuration": "Durasi satu sesi (menit)",
  "product.serviceMode": "Dikerjakan di mana",
  "product.serviceModeUnset": "Belum diatur",
  "product.serviceOnsite": "Di tempat",
  "product.serviceRemote": "Jarak jauh",
  "product.serviceBoth": "Bisa keduanya",
  "product.fulfillmentNote": "Catatan pemenuhan",
  "product.fulfillmentNoteHint": "Tampil ke pembeli setelah bayar. Mis. \"Dikirim H+1\" atau \"Kami hubungi untuk atur jadwal\".",

  /* ---- status pesanan ---- */
  "order.statusPending": "Menunggu diproses",
  "order.statusProcessing": "Sedang diproses",
  "order.statusDone": "Selesai",
  "order.statusCancelled": "Dibatalkan",
  "order.update": "Ubah status",
  "order.saveFailed": "Gagal menyimpan status.",
  ...
  "domains.certIssuing": "Menerbitkan sertifikat…",
  "domains.certElsewhere": "Belum dilayani dari sini",
  "domains.certFailed": "Sertifikat gagal",
  "domains.warm": "Terbitkan sertifikat",
  "domains.warming": "Menerbitkan…",
  ...
  "shipping.phone": "Nomor HP",
  "shipping.address": "Alamat lengkap",
  "shipping.city": "Kota / kabupaten",
  "shipping.province": "Provinsi",
  "shipping.postalCode": "Kode pos",
  "shipping.note": "Catatan untuk kurir",
  "shipping.incomplete": "Belum lengkap: {fields}.",
  "shipping.incompleteShort": "Lengkapi alamat pengiriman dulu.",
  "shipping.panelHeading": "Alamat kirim",
  "shipping.none": "Tidak ada alamat pada pesanan ini.",
  "product.soldOut": "Stok habis",
  "product.soldOutNote": "Produk ini sedang tidak tersedia. Coba lagi nanti atau hubungi penjual.",
  "product.stockLeft": "Sisa {count}",
  "checkout.orderReceived": "Pesanan Anda sudah diterima penjual dan akan segera diproses.",
  ...
  "sales.noProductsHint": "Buat produk pertama untuk mulai berjualan.",
