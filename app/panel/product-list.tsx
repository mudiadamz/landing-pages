              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-[var(--border)] bg-[var(--background)]/50">
                    <SortTh label={t("panel.title")} sortField="title" sortKey={sortKey} sortDir={sortDir} onSort={toggleSort} />
                    <th className="px-4 py-3.5 text-left text-sm font-medium text-foreground">Slug</th>
                    <SortTh label={t("panel.visits")} sortField="views" sortKey={sortKey} sortDir={sortDir} onSort={toggleSort} right />
                    <SortTh label={t("panel.updated")} sortField="updated" sortKey={sortKey} sortDir={sortDir} onSort={toggleSort} />
