/**
 * The small leaf components the product editor's tabs share: a bulleted check
 * row and the stroke icons.
 *
 * These lived at the bottom of product-edit-form.tsx while it was one file. Now
 * that the tabs are their own components they need a common home — and an icon
 * is the last thing that should be duplicated per tab, since the whole point of
 * these six is that every tab draws the same trash can.
 */
